...
const Key = tw.div`font-medium text-green-800`;

const PrimaryButton = tw(PrimaryButtonBase)`mt-8 md:mt-10 text-sm inline-block mx-auto md:mx-0`;

const DecoratorBlob = styled(SvgDotPattern)(props => [
  tw`w-20 h-20 absolute right-0 bottom-0 transform translate-x-1/2 translate-y-1/2 fill-current text-green-800 -z-10`
]);

export default ({
  subheading = "Our Web App",
  heading = (
    <>
      We help you to make <wbr /> <span tw="text-primary-333">sustainable</span>
      <wbr /> & <wbr /> <br/><span tw="text-primary-333">cost efficient</span>

...
const QuestionToggleIcon = styled.span`
  ${tw`ml-2 bg-green-800 text-gray-100 p-1 rounded-full group-hover:bg-green-800 group-hover:text-gray-200 transition duration-300`}
  svg {
    ${tw`w-4 h-4`}
  }
`;
...
export default ({
  subheading = "",
  heading = "Questions",
  description = "Here are some frequently asked questions about our product. Should you have any other questions, feel free to reach out via the contact form below.",
